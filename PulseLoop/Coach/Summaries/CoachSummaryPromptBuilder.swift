...
enum CoachSummaryPromptBuilder {
    static func systemPrompt(kind: CoachSummaryKind) -> String {
        ...
        - When a `nutrition` block is present, you may fold intake into the insight (calories vs the eating goal, protein). Matter-of-fact, never shaming; `goals.calorie_intake_daily` is the EATING goal, `today.calories` is energy burned.
